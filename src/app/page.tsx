...
export default async function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_-8%,rgba(206,172,148,0.6),transparent_44%),radial-gradient(circle_at_84%_102%,rgba(172,146,134,0.6),transparent_62%)] dark:bg-[radial-gradient(circle_at_14%_-12%,rgba(148,30,58,0.05),transparent_40%),radial-gradient(circle_at_82%_102%,rgba(110,34,60,0.2),transparent_54%)]"
      />
      ...
      <section className="relative z-10 grid min-h-screen grid-cols-1 lg:grid-cols-[minmax(220px,28%)_minmax(0,1fr)]">
        <div className="relative hidden border-r border-border/70 lg:block">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_26%_24%,rgba(208,174,152,0.1),transparent_50%),radial-gradient(ellipse_at_74%_76%,rgba(178,152,140,0.04),transparent_60%),linear-gradient(140deg,rgba(255,255,255,0.08),transparent_56%)] dark:bg-[radial-gradient(ellipse_at_22%_20%,rgba(156,24,56,0.02),transparent_46%),radial-gradient(ellipse_at_78%_74%,rgba(196,74,56,0.15),transparent_52%),linear-gradient(140deg,rgba(130,24,56,0.1),transparent_48%)]"
          />
